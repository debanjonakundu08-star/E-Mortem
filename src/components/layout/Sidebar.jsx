  ...
  return (
    <>
      ...
      >
          ...
          <NavLink to="/" className="flex items-center gap-3 group" onClick={onClose}>
            ...
            <div>
              <div className="font-extrabold text-slate-900 dark:text-white text-lg tracking-tight leading-tight flex items-center gap-1.5 font-sans">
                E-Mortem
                <span className="inline-block w-2 h-2 rounded-full bg-teal-500 dark:bg-teal-400 animate-pulse"></span>
              </div>
              <div className="text-[10px] font-medium tracking-normal text-teal-600 dark:text-teal-400/90 leading-tight">
        ...
        {/* Quick Demo Banner */}
        <div className="p-3.5 mx-3.5 my-3.5 rounded-2xl bg-slate-50 dark:bg-charcoal-900/90 border border-teal-500/25 shadow-sm dark:shadow-lg relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-24 h-24 bg-teal-500/10 rounded-full blur-xl pointer-events-none" />
          <div className="flex items-center gap-1.5 text-xs font-semibold text-teal-700 dark:text-teal-400 mb-1">
            ...
            return (
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center justify-between px-3 py-2.5 rounded-xl text-xs sm:text-sm font-medium transition-all ${
                    isActive
                      ? "bg-teal-50 text-teal-800 border border-teal-200 dark:bg-teal-500/15 dark:text-teal-300 dark:border-teal-500/30 font-semibold shadow-sm"
              ...
              >
                ...
                {item.badge !== undefined && (
                  <span className="px-2 py-0.5 text-[10px] font-semibold rounded-full bg-slate-200 text-slate-700 border border-slate-300 dark:bg-charcoal-800 dark:text-slate-300 dark:border-charcoal-700">
                    {item.badge}
                  </span>
                )}
              </NavLink>
