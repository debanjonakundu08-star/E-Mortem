    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-[70vh] flex items-center justify-center p-6">
          <div className="max-w-lg w-full p-8 rounded-3xl bg-slate-900 border border-rose-500/40 text-center shadow-2xl space-y-6">
            ...
            {this.state.error && (
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 text-left overflow-auto max-h-32 text-xs font-mono text-rose-300">
