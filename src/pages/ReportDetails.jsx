    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-24">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-charcoal-800 pb-5">
        <div>
          ...
          <h1 className="text-2xl sm:text-4xl font-extrabold text-white tracking-tight flex items-center gap-2 font-sans">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          <button
            ...
            className="p-2.5 rounded-xl bg-charcoal-900 border border-charcoal-800 text-slate-400 hover:text-white transition-colors"
          ...
          {!saved ? (
            <button
              type="button"
              onClick={handleSave}
              className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold bg-teal-400 hover:bg-teal-300 text-slate-950 shadow-glow-teal transition-all active:scale-95"
            >
            ...
            <Link
              to="/reports"
              className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold bg-teal-500/15 border border-teal-400 text-teal-300 transition-all"
            >
          ...
          <Link
            to="/diagnose"
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold bg-charcoal-900 hover:bg-charcoal-800 text-slate-300 border border-charcoal-800 transition-colors"
          >
      ...
      {/* ------------------------------------------------------------- */}
      <div className="e-panel-elevated p-6 sm:p-8 rounded-3xl border-charcoal-800 bg-gradient-to-br from-charcoal-900 via-charcoal-950 to-[#070E14] shadow-panel relative overflow-hidden">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-3.5 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-500/10 text-teal-300 border border-teal-500/30 text-xs font-mono font-bold uppercase tracking-wider">
            ...
            <div className="pt-2 flex flex-wrap items-center justify-center lg:justify-start gap-4 text-xs">
              <div className="flex items-center gap-1.5 text-slate-300 bg-charcoal-950/80 px-3 py-1.5 rounded-xl border border-charcoal-800">
                <Smartphone className="w-4 h-4 text-teal-400" />
                <span>Device: <strong className="text-white">{device.type || device.device_type || "Smartphone"}</strong></span>
              </div>
              <div className="flex items-center gap-1.5 text-slate-300 bg-charcoal-950/80 px-3 py-1.5 rounded-xl border border-charcoal-800">
          ...
          <div className="lg:col-span-6 flex flex-col sm:flex-row items-center justify-center gap-6 p-4 rounded-2xl bg-charcoal-950/80 border border-charcoal-800">
            {/* Ring 1: Health Score */}
            ...
            <div className="hidden sm:block w-px h-24 bg-charcoal-800" />
      ...
      {/* ------------------------------------------------------------- */}
      <div className="e-panel-elevated p-6 rounded-2xl border-teal-500/30 bg-gradient-to-r from-charcoal-900 via-charcoal-950 to-[#08120E] flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-teal-500/15 border border-teal-500/30 text-teal-300 flex items-center justify-center shrink-0 shadow-sm">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono font-extrabold px-2.5 py-0.5 rounded-full bg-teal-500/20 text-teal-300 border border-teal-500/40">
                {device.repairVsReplace?.verdictText?.replace("🟢", "").trim() || "REPAIR FIRST"}
              </span>
            </div>
            <p className="text-xs text-slate-300 mt-1">
              Estimated repair (<strong className="text-teal-300">{device.repairVsReplace?.estimatedRepairCost || "₹1,500 – ₹3,000"}</strong>) is only ~16% of device value (<strong className="text-white">₹{Number(device.currentValue || 18000).toLocaleString("en-IN")}</strong>).
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 shrink-0 self-end md:self-center">
          <div className="text-right">
            <span className="text-[10px] font-mono text-slate-400 uppercase block">CAPEX Saved</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="p-4 rounded-2xl bg-charcoal-900/80 border border-charcoal-800 flex items-center justify-between">
          <div>
      ...
      {/* ------------------------------------------------------------- */}
      <div className="e-panel-elevated p-6 sm:p-7 rounded-3xl border-charcoal-800 bg-charcoal-900/70">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4 pb-3 border-b border-charcoal-800">
          <div>
          ...
          <span className="text-[11px] px-2.5 py-0.5 rounded-full bg-charcoal-800 text-slate-400 font-mono border border-charcoal-700">
        ...
        <div className="space-y-3">
          {device.probableCauses && Array.isArray(device.probableCauses) && device.probableCauses.map((cause, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-4 rounded-2xl bg-charcoal-950/80 border border-charcoal-800 space-y-2 hover:border-charcoal-700 transition-colors"
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div className="flex items-center gap-3">
                    <span className="text-xs font-mono font-bold px-2 py-1 rounded-lg bg-charcoal-800 text-teal-300 border border-charcoal-700 shrink-0">
                      0{rank}
                    </span>
                ...
                {evidence && evidence.length > 0 && (
                  <div className="pt-2 pl-9 border-t border-charcoal-800/80 mt-2">
                    <span className="text-[10px] font-mono text-teal-400 font-semibold block mb-1">
                      Why we think this:
                    </span>
        ...
        <div className="mt-4 p-3 rounded-xl bg-charcoal-950 border border-charcoal-800 text-xs text-slate-400 flex items-start gap-2">
      ...
      {/* ------------------------------------------------------------- */}
      <div className="e-panel-elevated p-6 sm:p-7 rounded-3xl border-teal-500/20 bg-gradient-to-r from-teal-950/20 via-charcoal-900 to-charcoal-950">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="e-panel-elevated p-6 rounded-3xl border-charcoal-800 bg-charcoal-900/70 space-y-4">
        ...
        <div className="e-panel-elevated p-6 rounded-3xl border-charcoal-800 bg-charcoal-900/70 space-y-4 flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-3 text-xs">
              <div className="p-3.5 rounded-xl bg-charcoal-950/80 border border-charcoal-800">
                <div className="flex justify-between font-bold text-white mb-1">
                  <span>Potentially Replaceable</span>
                  <span className="text-teal-300 font-mono">Modular Component</span>
                </div>
              ...
              <div className="p-3.5 rounded-xl bg-charcoal-950/80 border border-charcoal-800">
                <div className="flex justify-between font-bold text-white mb-1">
                  ...
                  <span className={isDataRecoverable ? "text-cyan-400 font-mono" : "text-amber-400 font-mono"}>
              ...
              <div className="p-3.5 rounded-xl bg-charcoal-950/80 border border-charcoal-800">
                <div className="flex justify-between font-bold text-white mb-1">
                  ...
                  <span className="text-emerald-400 font-mono">Secondary Life</span>
                </div>
                <p className="text-slate-400 leading-relaxed text-[11px]">
      ...
      {/* ------------------------------------------------------------- */}
      <div className="e-panel-elevated p-6 sm:p-7 rounded-3xl border-charcoal-800 bg-charcoal-900/70">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5 pb-3 border-b border-charcoal-800">
          <div>
          ...
          <span className="text-[10px] font-mono text-amber-300 bg-amber-500/10 px-2.5 py-1 rounded-lg border border-amber-500/30 self-start sm:self-center">
            Prototype estimate &bull; Not guaranteed
          </span>
        </div>

        {/* Toggle Buttons */}
        <div className="flex items-center gap-2 p-1 rounded-2xl bg-charcoal-950 border border-charcoal-800 max-w-sm mb-5">
          <button
            type="button"
            onClick={() => setSimMode("repair")}
            className={`flex-1 py-2 px-3 rounded-xl text-xs font-bold transition-all ${
              simMode === "repair"
                ? "bg-teal-400 text-slate-950 shadow-glow-teal"
        ...
        {simMode === "repair" ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-2xl bg-charcoal-950/80 border border-teal-500/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-2xl bg-charcoal-950/80 border border-rose-500/30">
      ...
      {/* ------------------------------------------------------------- */}
      <div className="e-panel-elevated p-6 sm:p-7 rounded-3xl border-charcoal-800 bg-charcoal-900/70">
        <div className="mb-4 pb-3 border-b border-charcoal-800 flex items-center justify-between">
          <div>
            <h3 className="text-base font-bold text-white flex items-center gap-2">
              <Sparkles className="w-4 h-4 text-teal-400" />
        ...
        <div className="space-y-2.5">
          {device.actionPlan && Array.isArray(device.actionPlan) && device.actionPlan.map((act, idx) => (
            <div
              key={act.step || idx}
              className="p-3.5 rounded-2xl bg-charcoal-950/80 border border-charcoal-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs"
            >
              <div className="flex items-start gap-3">
                <span className="font-mono font-bold text-teal-300 px-2 py-0.5 rounded-lg bg-charcoal-800 border border-charcoal-700 shrink-0">
                  {act.step || idx + 1}
                </span>
                <div>
      ...
      {/* ------------------------------------------------------------- */}
      <div className="e-panel-elevated p-6 sm:p-7 rounded-3xl border-teal-500/30 bg-gradient-to-b from-charcoal-900 to-charcoal-950 shadow-panel">
        <div className="mb-4">
          <div className="flex items-center gap-2 text-xs font-bold text-teal-400 uppercase tracking-wider font-mono mb-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-xs">
          {device.technicianQuestions && Array.isArray(device.technicianQuestions) && device.technicianQuestions.map((q, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-3.5 rounded-2xl bg-charcoal-950/80 border border-charcoal-800 flex flex-col justify-between gap-2"
              >
                <div className="flex items-start gap-2.5">
                  <div className="w-5 h-5 rounded-full bg-teal-500/20 text-teal-300 border border-teal-500/30 flex items-center justify-center shrink-0 mt-0.5 text-[10px] font-bold">
                    {idx + 1}
                  </div>
                ...
                {whyItMatters && (
                  <div className="text-[10px] text-slate-400 font-mono pl-7 border-l-2 border-teal-500/30 mt-1">
      ...
      {/* ------------------------------------------------------------- */}
      <div className="space-y-3">
        <div className="p-4 rounded-2xl bg-charcoal-900/80 border border-teal-500/30 text-center">
          <p className="text-xs font-mono font-bold text-teal-300">
            «The device may have died. The investigation doesn't.»
          </p>
        </div>

        <div className="p-4 rounded-2xl bg-charcoal-950 border border-charcoal-800 text-xs text-slate-400 flex items-start gap-3">
          <Info className="w-4 h-4 text-slate-500 shrink-0 mt-0.5" />
          <p className="leading-relaxed text-[11px]">
