...
export default function JudgeDemoMode() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-7 pb-20">
      {/* Header */}
      <div className="border-b border-slate-200 dark:border-charcoal-800 pb-6 space-y-2">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-50 dark:bg-teal-500/10 border border-teal-200 dark:border-teal-500/30 text-teal-700 dark:text-teal-300 text-xs font-mono font-bold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {demoCases.map((c) => {
          ...
          return (
            <div
              key={c.id}
              className="e-panel-elevated p-6 rounded-3xl border-slate-200 dark:border-charcoal-800 bg-white dark:bg-charcoal-900/70 flex flex-col justify-between hover:border-teal-500/40 transition-all group space-y-5 shadow-sm dark:shadow-panel"
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="p-2.5 rounded-xl bg-slate-100 dark:bg-charcoal-800 border border-slate-200 dark:border-charcoal-700 text-teal-700 dark:text-teal-300 group-hover:scale-105 transition-transform">
                  ...
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-mono font-bold bg-slate-100 dark:bg-charcoal-800 border border-slate-200 dark:border-charcoal-700 text-slate-700 dark:text-slate-300">
                ...
                <div className="flex flex-wrap gap-1.5 pt-1">
                  {c.symptoms.map((s, idx) => (
                    <span
                      key={idx}
                      className="px-2 py-0.5 rounded text-[10px] font-mono bg-slate-100 dark:bg-charcoal-950 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-charcoal-800"
                    >
                      {s.replace("_", " ")}
                    </span>
                  ))}
              ...
              <div className="pt-4 border-t border-slate-200 dark:border-charcoal-800 flex items-center justify-between">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-400 hover:to-cyan-400 text-white dark:text-slate-950 transition-all shadow-sm dark:shadow-glow-teal active:scale-95"
                >
