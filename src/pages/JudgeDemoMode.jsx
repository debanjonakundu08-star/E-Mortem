...
export default function JudgeDemoMode() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-7 pb-20">
      {/* Header */}
      <div className="border-b border-charcoal-800 pb-6 space-y-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {demoCases.map((c) => {
          ...
          return (
            <div
              key={c.id}
              className="e-panel-elevated p-6 rounded-3xl border-charcoal-800 bg-charcoal-900/70 flex flex-col justify-between hover:border-teal-500/40 transition-all group space-y-5"
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="p-2.5 rounded-xl bg-charcoal-800 border border-charcoal-700 text-teal-300 group-hover:scale-105 transition-transform">
                  ...
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-mono font-bold bg-charcoal-800 border border-charcoal-700 text-slate-300">
                ...
                <div className="flex flex-wrap gap-1.5 pt-1">
                  {c.symptoms.map((s, idx) => (
                    <span
                      key={idx}
                      className="px-2 py-0.5 rounded text-[10px] font-mono bg-charcoal-950 text-slate-400 border border-charcoal-800"
                    >
                      {s.replace("_", " ")}
                    </span>
                  ))}
              ...
              <div className="pt-4 border-t border-charcoal-800 flex items-center justify-between">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold bg-gradient-to-r from-teal-400 to-cyan-400 hover:from-teal-300 hover:to-cyan-300 text-slate-950 transition-all shadow-glow-teal active:scale-95"
                >
